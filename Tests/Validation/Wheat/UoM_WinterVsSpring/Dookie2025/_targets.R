...
list(
  ...
  # Add spikes/m2
  tar_target(
    name = df_obs_wide_plus_pheno_hi_with_amounts_spike,
  ...
  tar_target(
    name = df_obs_wide_plus_pheno_hi_with_amounts_spike_harv,
    command = add_harv_into_obs(
      df            = df_obs_wide_plus_pheno_hi_with_amounts_spike,
  ...
  tar_target(
    name = qc_obs_final,
    command = check_obs_health(df_obs_wide_plus_pheno_hi_with_amounts_spike_harv)
  ),
